...
import { generateRandomString, setDefault, isDescendant, isUndefinedStringNumberBooleanOrNull } from '../../helpers/util.js';
...
export default class Combobox extends React.Component {
    ...
    sortByIndexOfFields({ baseItems, fields, index }) {
        ...
        if (Array.isArray(fields) === true && indexOfFields <= fields.length - 1) {
            ...
            baseItems.sort((a, b) => {
                ...
                if (a.__origin__[fieldName] === undefined && b.__origin__[fieldName] !== undefined) {

                    return BIG_COMPARATOR.localeCompare(b.__origin__[fieldName]);
                } else if (a.__origin__[fieldName] !== undefined && b.__origin__[fieldName] === undefined) {
    ...
    handleKeyDown(event) {
        ...
        if (event.key === 'Enter' && this.itemFocused instanceof BaseItem === true) {
    ...
    renderIconStyle() {
        ...
        return React.createElement(
            'span',
            { className: 'combobox__icon-style' },
    ...
    renderContent() {
        ...
        if (this.state.shouldRenderList === false || this.state.baseItemsFiltered.length === 0) {
    ...
    renderList() {
        ...
        return React.createElement(
            ...
            this.state.baseItemsFiltered.map((item, key) => {
                ...
                return React.createElement(ComboboxListItem, {
                    key: key,
                    item: item,
                    isFocused: isFocused,
